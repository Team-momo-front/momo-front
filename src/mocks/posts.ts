...
export const posts: Post[] = [
  ...
  },
  {
    ...
    approvedCount: 6,
    categories: ['디저트'],
    content: '연남동의 힙한 디저트 카페를 탐방하는 모임입니다. 연남동의 힙한 디저트 카페를 탐방하는 모임입니다. 연남동의 힙한 디저트 카페를 탐방하는 모임입니다. 연남동의 힙한 디저트 카페를 탐방하는 모임입니다. 연남동의 힙한 디저트 카페를 탐방하는 모임입니다. 연남동의 힙한 디저트 카페를 탐방하는 모임입니다.',
    thumbnail: 'image/korean_food_1.webp',
    place_name: '연남동',
    x: '126.925316',
    y: '37.565034',
